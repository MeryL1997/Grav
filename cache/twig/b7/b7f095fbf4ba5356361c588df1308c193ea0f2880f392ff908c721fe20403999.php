...
class __TwigTemplate_60f453364be2c6c133d535da1904308862a043108ed37c6f00c706d0a0669648 extends \Twig\Template
{
...
";
    ...
    public function block_input($context, array $blocks = [])
    {
        // line 9
        echo "    <div class=\"";
        echo ((($context["form_field_wrapper_classes"] ?? null)) ? (($context["form_field_wrapper_classes"] ?? null)) : ("form-select-wrapper"));
        echo " ";
        ...
        <select name=\"";
        // line 10
        echo ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->fieldNameFilter((($context["scope"] ?? null) . $this->getAttribute(($context["field"] ?? null), "name", []))) . (($this->getAttribute(($context["field"] ?? null), "multiple", [])) ? ("[]") : ("")));
        echo "\"
                class=\"";
        // line 11
        echo ($context["form_field_select_classes"] ?? null);
        echo " ";
        ...
        if ($this->getAttribute(($context["field"] ?? null), "form", [])) {
            echo "form=\"";
            echo $this->getAttribute(($context["field"] ?? null), "form", []);
            echo "\"";
        }
        // line 21
        echo "                ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["item_value"]) {
            ...
            if ((twig_test_iterable($context["item_value"]) && $this->getAttribute($context["item_value"], "value", []))) {
                ...
                echo "
                        ";
                // line 43
                echo (($this->getAttribute($context["item_value"], "label", [])) ? (("label=" . $this->getAttribute($context["item_value"], "label", []))) : (""));
                echo "
                        value=\"";
                // line 44
                echo $this->getAttribute($context["item_value"], "akey", []);
                echo "\"
                    >
                        ";
                // line 46
...
{% endblock %}
", "forms/fields/select/select.html.twig", "C:\\xampp\\htdocs\\GyA\\user\\plugins\\form\\templates\\forms\\fields\\select\\select.html.twig");
    }
}
