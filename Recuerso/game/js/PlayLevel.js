...
TreasureHunter.PlayLevel.prototype = {
    ...
    create: function () {
		...
		//En esta parte se define la velocidad del personaje, al ser cambiado a un valor menor será mas lento
        ...
        //Agregamos variable de inmortalidad
        inmortal=false;
        //Agregamos variable score
        score=0;
        /////////////////////////////////
        ...
        //Agregamos texto
        texto = game.add.text(100,20,"score: ");
        texto.fill="white";
    },
    ...
    update: function () {
        ...
        if (this.gameStarted && this.isPlayerAlive) {
            //Aqui comprobamos el evento del cursor para verificar la tecla oprimida y aumentamos velocidad
            if (this.input.keyboard.isDown(Phaser.Keyboard.M)){                    
                    this.playerVelocity+=50;                   
            }
            //Aqui disminuimos la velocidad 
            ...
            if (this.input.keyboard.isDown(Phaser.Keyboard.I)){                
                    if(inmortal==false){
                        alert("inmortalidad activada");
                        inmortal=true;
                    }else{
                        alert("inmortalidad desactivada");
                        inmortal=false;
                    }
            } 
            this.movePlayer();
    ...
    createTreasureChest: function () {        
        ...
        //Aqui se agrega valores a las variables para poder modificar la posicion del cofre
        this.treasureChest = this.add.sprite(treasureChest[0].x+220, treasureChest[0].y-20, treasureChest[0].type);
